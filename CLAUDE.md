...
- Docking GPU : GNINA via RunPod serverless (docs/GNINA_GPU_RunPod.md)
...
- Logger resultats dans docs/PROGRESS_V9.md

## STRUCTURE PROJET
- docs/ : CDC, specs, methodes
- docs/archive/ : anciens CDC V2-V8
